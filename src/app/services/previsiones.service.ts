...
>>>>>>> 5723808 (	new file:   src/app/services/previsiones.service.ts)
...
export class PrevisionesService {
  ...
  private viviendas: WritableSignal<IVivienda[]> | undefined;
  private previsiones: WritableSignal<IPrevision[]> | undefined;
  private prevision: IPrevision | undefined ;
...
=======
    ...
    if ( this.numIrves< minIrve){
      ...
      if (vivTemp?.conIrve!=undefined){
        ...
        if (vivTemp.id){this.eliminaVivienda(vivTemp.id)};
        this.agregraVivienda(vivTemp!);
        //this.calculaP1();
      }
